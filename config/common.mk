...
# Copy msm custom changelog to the device
PRODUCT_COPY_FILES += \
    vendor/cm/CHANGELOG_MSM.mkdn:system/etc/CHANGELOG-MSM7X30.txt
...
PRODUCT_COPY_FILES += \
	...
	vendor/cm/prebuilt/msm7x30/QuickBoot/QuickBoot.apk:system/priv-app/QuickBoot.apk
...
ifdef CM_BUILDTYPE
    ...
    CM_BUILDTYPE := Resurrection-Remix-LP-v5.5.1
    CM_EXTRAVERSION :=
endif
